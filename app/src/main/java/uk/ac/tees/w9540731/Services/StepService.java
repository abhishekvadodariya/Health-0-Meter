package uk.ac.tees.w9540731.Services;
...
import uk.ac.tees.w9540731.Activities.HomeScreenActivity;
import uk.ac.tees.w9540731.HelperClasses.Constants;
import uk.ac.tees.w9540731.Models.Steps;
...
public class StepService extends Service implements SensorEventListener {
    ...
    public HashMap<String,String> getData(){
        ...
        data.put("steps", String.valueOf(1));
        data.put("distance",String.format(getString(R.string.distance),distanceString));
